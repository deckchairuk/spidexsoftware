			...
			<div class="col">
				<div class="header__inner">
					...
					<div class="logo">
						...
						<?php if (is_page_template('templates/template-index-products.php') || is_singular('products') || is_page_template('templates/template-index-articles.php') || is_singular('articles') || is_singular('projects') || is_page('What we do') || is_page('Resources')): ?>
